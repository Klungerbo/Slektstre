...
public:
    ...
    explicit node(std::string name, int age) : name_(std::move(name)), age_(age) {};

    explicit node(std::string name, int age, std::string gender) : name_(std::move(name)), age_(age),
